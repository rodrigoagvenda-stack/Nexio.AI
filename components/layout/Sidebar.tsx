  ...
  },
  {
    ...
    links: [
      ...
      { href: '/prospect', label: 'Orbit', icon: Radar },
      {
        ...
        icon: BotIcon,
        children: [
          { href: '/automacoes', label: 'Visão geral', icon: ListChecks },
          { href: '/configuracoes/follow', label: 'Sequências', icon: CursorClickIcon },
          { href: '/configuracoes/sdr', label: 'SDR', icon: BotMessageSquareIcon },
          { href: '/outbound', label: 'Outbound', icon: SendIcon },
          { href: '/configuracoes/agenda', label: 'Calendário', icon: CalendarDaysIcon },
