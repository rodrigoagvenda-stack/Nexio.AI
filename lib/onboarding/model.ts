...
export const PLANS: { id: PlanIntent; name: string; price: number; popular?: boolean; features: string[] }[] = [
  { id: 'starter', name: 'ZAAPPLY START', price: 297, features: ['Agente SDR com IA', 'Atendimento via chat', 'CRM Kanban', 'Métricas e relatórios', '1 número de WhatsApp'] },
  { id: 'pro', name: 'ZAAPPLY GROWTH', price: 497, popular: true, features: ['Tudo do Start', 'Google Calendar integrado', '2 números de WhatsApp'] },
];
