...
async function runAgentePipeline(
  ...
  const systemPrompt = ctx.agentPrompts['pipeline'] || DEFAULT_AGENT_PROMPTS['pipeline']
...
async function runAgenteSegmentacao(
  ...
  const systemPrompt = ctx.agentPrompts['segmentacao'] || DEFAULT_AGENT_PROMPTS['segmentacao']
...
async function runAgenteOutbound(
  ...
  const systemPrompt = ctx.agentPrompts['outbound'] || DEFAULT_AGENT_PROMPTS['outbound']
...
async function runMemoryExpert(
  ...
  const systemPrompt = ctx.agentPrompts['memory'] || DEFAULT_AGENT_PROMPTS['memory']
...
async function runAgenteAgendamento(
  ...
  const baseAgendamento = ctx.agentPrompts['agendamento'] || DEFAULT_AGENT_PROMPTS['agendamento']
  const systemPrompt = `Data e hora atual: ${now}\n\n${baseAgendamento}`
