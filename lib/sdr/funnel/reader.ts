...
Formato:
{"categoria": "<uma das categorias>", "objecao_tipo": <chave da lista de objeções ou null>, "dados": {"<campo>": "<valor>" ou null}, "confianca": <número de 0 a 1>}
...
export function validateReading(raw: unknown, config: FunnelConfig): Reading | null {
  ...
  return { categoria: categoria as Categoria, objecaoTipo: tipo, dados, confianca }
}
