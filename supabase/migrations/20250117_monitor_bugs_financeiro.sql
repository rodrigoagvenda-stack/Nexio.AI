...
-- RLS Policies para system_bugs
ALTER TABLE system_bugs ENABLE ROW LEVEL SECURITY;

-- Admin pode ver todos os bugs
...
-- Usuários podem criar bugs para sua empresa
...
-- Usuários podem ver bugs da sua empresa
...
-- Apenas admins podem ver, criar e gerenciar transações
