...
CREATE POLICY "briefing_config_service_all" ON briefing_config
  FOR ALL USING (true);

-- Público pode inserir respostas
CREATE POLICY "briefing_responses_public_insert" ON briefing_responses
  FOR INSERT WITH CHECK (true);

-- Apenas admins podem ver respostas
CREATE POLICY "briefing_responses_admin_select" ON briefing_responses
  FOR SELECT USING (
