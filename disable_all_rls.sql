-- =============================================
-- DESABILITAR COMPLETAMENTE O RLS (TEMPORÁRIO)
-- Execute no SQL Editor do Supabase
-- =============================================

-- PASSO 1: Remover TODAS as policies de TODAS as tabelas
DO $$
DECLARE
    r RECORD;
BEGIN
    FOR r IN (
        ...
        RAISE NOTICE 'Removida policy: % na tabela %', r.policyname, r.tablename;
    END LOOP;
END $$;

-- PASSO 2: Remover TODAS as funções helper
