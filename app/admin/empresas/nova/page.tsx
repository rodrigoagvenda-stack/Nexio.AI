          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { value: 'basic', name: 'ZAAPPLY START', price: 'R$ 1.600', icon: Building2, color: 'from-blue-500/20 to-blue-600/20', features: ['CRM Completo', 'Chat IA', 'Funil de Vendas'] },
                  { value: 'performance', name: 'ZAAPPLY GROWTH', price: 'R$ 2.000', icon: TrendingUp, color: 'from-green-500/20 to-green-600/20', features: ['Tudo do START', '+ Leads ICP', 'Extração Inteligente'] },
                  { value: 'advanced', name: 'ZAAPPLY PRO', price: 'R$ 2.600', icon: Zap, color: 'from-orange-500/20 to-orange-600/20', features: ['Tudo do GROWTH', '+ Gestão de Tráfego', 'Facebook Ads'] },
                ].map((plan) => {
