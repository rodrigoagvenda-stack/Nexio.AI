...
export default async function DashboardLayout({
  ...
  // Feature gate só pela flag do admin : exigir config já existente também
  // travava um beco sem saída pra quem nunca configurou ainda (a tela só
  // aparecia depois de configurar, mas configurar exigia achar a tela).
